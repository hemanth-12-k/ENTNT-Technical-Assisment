...
export default function MessagesPage() {
  ...
  const [messages] = useState<Message[]>([
    {
      ...
      content: "Hi John, this is a reminder about your upcoming appointment on January 20th at 2:00 PM.",
    ...
    },
    {
      ...
      content: "Of course! I'll have my assistant schedule a follow-up appointment for you. Please call the office.",
  ...
  const handleSendMessage = () => {
    ...
    addNotification({
      title: "Message Sent",
      message: `Your message "${newMessage.subject}" has been sent successfully.`,
      type: "success",
    })
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            {user?.role === "Admin" ? "Communicate with patients" : "Messages from your dental practice"}
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Send a message to a patient or colleague</CardDescription>
            </CardHeader>
